...
%    \end{tightemize}
%    \vspace{5pt}
%\item Led the training and development of machine learning models for our multi-task monitoring system 
...
% \item Developed a website UI that displays the live system outputs in a clear and concise manner for debugging and demonstration purposes
...
%\descript{| Red Hat}
%\location{January 2025 - present | Raleigh, NC}
%\begin{tightemize}
